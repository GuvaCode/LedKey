...
uses
  DynLibs, IntfGraphics, GraphType, Types, CTypes, LazUTF8;
...
begin
  ...
  try
    @cairo_image_surface_create:= GetProcedureAddress(libcairo, 'cairo_image_surface_create');
    @cairo_surface_destroy:= GetProcedureAddress(libcairo, 'cairo_surface_destroy');
    @cairo_image_surface_get_data:= GetProcedureAddress(libcairo, 'cairo_image_surface_get_data');
    @cairo_create:= GetProcedureAddress(libcairo, 'cairo_create');
    @cairo_destroy:= GetProcedureAddress(libcairo, 'cairo_destroy');
    @cairo_scale:= GetProcedureAddress(libcairo, 'cairo_scale');

    @rsvg_handle_new_from_file:= GetProcedureAddress(librsvg, 'rsvg_handle_new_from_file');
    @rsvg_handle_new_from_data:= GetProcedureAddress(librsvg, 'rsvg_handle_new_from_data');
    @rsvg_handle_get_dimensions:= GetProcedureAddress(librsvg, 'rsvg_handle_get_dimensions');
    @rsvg_handle_render_cairo:=  GetProcedureAddress(librsvg, 'rsvg_handle_render_cairo');

    @g_type_init:= GetProcedureAddress(libgobject, 'g_type_init');
    @g_object_unref:= GetProcedureAddress(libgobject, 'g_object_unref');
...
procedure Finalize;
begin
//   ImageHandlers.UnregisterImageHandlers('Scalable Vector Graphics');
//   TPicture.UnregisterGraphicClass(TScalableVectorGraphics);
