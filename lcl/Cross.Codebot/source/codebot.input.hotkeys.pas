...
begin
  case Key of
    ...
    VK_SCROLL: Result:= XK_Scroll_Lock; //addet
    VK_NUMLOCK: Result:= XK_Num_Lock;//addet
    VK_0: Result := XK_0;
    VK_1: Result := XK_1;
    VK_2: Result := XK_2;
    VK_3: Result := XK_3;
...
begin
  case Sym of
    ...
    XK_Scroll_Lock: Result:=VK_SCROLL; //addet
    XK_Num_Lock: Result:= VK_NUMLOCK;//addet
    XK_0: Result := VK_0;
    XK_1: Result := VK_1;
    XK_2: Result := VK_2;
    XK_3: Result := VK_3;
...
begin
  ...
  FDisplay := gdk_x11_get_default_xdisplay;
  //GDK_WINDOW_XDISPLAY(FRoot);
end;
...
begin
  case Key of
    ...
    VK_HELP: Result := True;
    VK_SCROLL: Result:=True;//addet
    VK_NUMLOCK: Result:=True;//addet
    VK_0: Result := True;
    VK_1: Result := True;
    VK_2: Result := True;
    VK_3: Result := True;
